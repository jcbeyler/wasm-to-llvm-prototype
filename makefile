...
OBJS = $(SRC_OBJ) $(PARSER_SRC_OBJ) $(GENERATED_OBJ)

INCLUDEDIR = -I`llvm-config --includedir` -Isrc/parser -Isrc
CFLAGS = -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS -g -std=gnu++0x $(INCLUDEDIR)
