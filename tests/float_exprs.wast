...
(module
  (func $f32.second_no_fold_div_0 (param $x f32) (result f32)
    (f32.div (get_local $x) (f32.const -0.0)))
  (export "f32.second_no_fold_div_0" $f32.second_no_fold_div_0)

  (func $f64.second_no_fold_div_0 (param $x f64) (result f64)
    (f64.div (get_local $x) (f64.const -0.0)))
  (export "f64.second_no_fold_div_0" $f64.second_no_fold_div_0)
)

(assert_return (invoke "f32.second_no_fold_div_0" (f32.const 1.0)) (f32.const -infinity))
(assert_return (invoke "f32.second_no_fold_div_0" (f32.const -1.0)) (f32.const infinity))
(assert_return (invoke "f32.second_no_fold_div_0" (f32.const infinity)) (f32.const -infinity))
(assert_return (invoke "f32.second_no_fold_div_0" (f32.const -infinity)) (f32.const infinity))
(assert_return_nan (invoke "f32.second_no_fold_div_0" (f32.const 0)))
(assert_return_nan (invoke "f32.second_no_fold_div_0" (f32.const -0)))
(assert_return_nan (invoke "f32.second_no_fold_div_0" (f32.const nan)))
(assert_return (invoke "f64.second_no_fold_div_0" (f64.const 1.0)) (f64.const -infinity))
(assert_return (invoke "f64.second_no_fold_div_0" (f64.const -1.0)) (f64.const infinity))
(assert_return (invoke "f64.second_no_fold_div_0" (f64.const infinity)) (f64.const -infinity))
(assert_return (invoke "f64.second_no_fold_div_0" (f64.const -infinity)) (f64.const infinity))
(assert_return_nan (invoke "f64.second_no_fold_div_0" (f64.const 0)))
(assert_return_nan (invoke "f64.second_no_fold_div_0" (f64.const -0)))
(assert_return_nan (invoke "f64.second_no_fold_div_0" (f64.const nan)))
